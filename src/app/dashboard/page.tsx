    ...
    <div className="min-h-screen bg-gradient-to-br from-black via-gray-900 to-black p-8">
      ...
      <div className="grid grid-cols-1 md:grid-cols-4 gap-6 mb-8">
        ...
        <motion.div 
          ...
          whileHover={{ scale: 1.02, y: -4 }}
        >
          <div className="bg-gradient-to-br from-gray-800/50 to-gray-900/50 backdrop-blur-xl border border-gray-700/50 rounded-xl p-6 hover:border-green-500/50 hover:shadow-lg hover:shadow-green-500/20 transition-all duration-300 cursor-pointer">
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
        <motion.div 
          ...
          whileHover={{ scale: 1.02, y: -4 }}
          className="bg-gradient-to-br from-cyan-500/10 to-blue-500/10 border border-cyan-500/20 rounded-xl p-6 cursor-pointer hover:border-cyan-500/50 hover:shadow-lg hover:shadow-cyan-500/20 transition-all"
        >
          ...
          <motion.a 
            ...
            whileTap={{ scale: 0.95 }}
            className="inline-block px-4 py-2 bg-cyan-500 text-black rounded-lg hover:bg-cyan-400 transition-colors font-medium shadow-lg hover:shadow-cyan-500/50"
          >
            Upload File
          </motion.a>
        </motion.div>
        ...
        <motion.div 
          ...
          whileHover={{ scale: 1.02, y: -4 }}
          className="bg-gradient-to-br from-purple-500/10 to-pink-500/10 border border-purple-500/20 rounded-xl p-6 cursor-pointer hover:border-purple-500/50 hover:shadow-lg hover:shadow-purple-500/20 transition-all"
        >
          ...
          <motion.a 
            ...
            whileHover={{ scale: 1.05 }}
            whileTap={{ scale: 0.95 }}
            className="inline-block px-4 py-2 bg-purple-500 text-white rounded-lg hover:bg-purple-400 transition-colors font-medium shadow-lg hover:shadow-purple-500/50"
          >
            Review Now
          </motion.a>
        </motion.div>
