...
export default function DashboardLayout({ children }: { children: React.ReactNode }) {
  ...
  return (
    <div className="min-h-screen bg-black">
        ...
        {mobileMenuOpen && (
          <>
            ...
            <motion.div
              ...
              className="lg:hidden fixed top-0 left-0 bottom-0 w-64 bg-gradient-to-b from-gray-900 to-black border-r border-gray-800 z-50 overflow-y-auto"
            >
      ...
      {/* Desktop Sidebar */}
      <aside className="hidden lg:block fixed top-0 left-0 bottom-0 w-64 bg-gradient-to-b from-gray-900 to-black border-r border-gray-800 overflow-y-auto">
